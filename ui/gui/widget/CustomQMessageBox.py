...
class CustomQMessageBox:
    def _init_ui(self, dialog: QMessageBox, title: str, label: str, icon_path: str):
        ...
        icon = QPixmap(icon_path).scaledToHeight(48, Qt.TransformationMode.SmoothTransformation)
    ...
    def warning(cls, parent, title, label, buttons=QMessageBox.StandardButton.Ok) -> QMessageBox:
        return cls._get_dialog(QMessageBox.Icon.Warning, parent, title, label, "ui/gui/resources/messages/error.png", buttons)
